#!/usr/bin/env node
// Run migration 018_seo_competitor_agent.sql against Supabase
// Usage: SUPABASE_PERSONAL_ACCESS_TOKEN=xxx node scripts/run-migration-018.js
...
const sql = fs.readFileSync(
  path.join(__dirname, '../supabase/migrations/018_seo_competitor_agent.sql'),
  'utf8'
)
